...
const EndlessTrafficDetails = () => (
  <>
    <div className="center carousel">
      <img src="https://is5-ssl.mzstatic.com/image/thumb/PurpleSource125/v4/70/44/f1/7044f1a5-1f39-23e0-62fb-ada91bf2dac5/13b422e0-efa2-45eb-bb70-30fe4544e955_StoreScreenhotTall1.png/314x0w.webp" alt="screenshot" height="340" width="157" />
      <img src="https://is1-ssl.mzstatic.com/image/thumb/PurpleSource115/v4/58/ad/0a/58ad0a84-9306-e193-b638-f7e0aa354847/7576c88b-61d5-4d93-b518-a1b973785494_StoreScreenhotTall2.png/314x0w.webp" alt="screenshot" height="340" width="157" />
    </div>
    <Margin height={64} />
    <p>
      A classic hit game has been reimagined exclusively for the iPhone.
      Don&#39;t settle for pixillated old versions when you can get:
    </p>
    <ul>
      ...
      <li>Magic Wand - use the magic wand button to instantly vanish all the cars and get you out of a &#34;jam&#34;</li>
    ...
    <p>
      Play this addictive casual arcade game today - it&#39;s FREE!
    </p>
    <Margin height={64} />

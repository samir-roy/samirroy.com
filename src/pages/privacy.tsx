...
const PrivacyPage = () => (
  <Page title="Privacy Notice">
    <article>
      ...
      <p><strong>Last updated September 21, 2021</strong><br /><br /></p>
      <p>
        Thank you for choosing to be part of our community at Samiroy LLC (&#34;<strong>Company</strong>,&#34;
      ...
      <ul>
        <li>Visit our website at <a href="http://www.samiroy.com" target="_blank" rel="noreferrer">http://www.samiroy.com</a></li>
        <li>Visit our website at <a href="http://www.samirroy.com" target="_blank" rel="noreferrer">http://www.samirroy.com</a></li>
        <li>Visit our website at <a href="http://www.poonji.io" target="_blank" rel="noreferrer">http://www.poonji.io</a></li>
        <li>Download and use our mobile application — Endless Traffic</li>
        <li>Download and use our mobile application — Poonji</li>
        <li>Engage with us in other related ways ― including any sales, marketing, or events</li>
      </ul>
      <p>In this privacy notice, if we refer to:</p>
      <ul>
        <li>&#34;<strong>Website</strong>,&#34; we are referring to any website of ours that references or links to this policy
        </li>
        <li>
          &#34;<strong>App</strong>,&#34; we are referring to any application of ours that references or links to this policy,
      ...
      <p>
        ...
        way possible what information we collect, how we use it, and what rights you have in relation to it. If
        there are any terms in this privacy notice that you do not agree with, please discontinue use of our
      ...
      <div><a href="#infouse">2. HOW DO WE USE YOUR INFORMATION?</a></div>
      <div><a href="#infoshare">3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a></div>
      <div><a href="#inforetain">4. HOW LONG DO WE KEEP YOUR INFORMATION?</a></div>
      <div><a href="#infosafe">5. HOW DO WE KEEP YOUR INFORMATION SAFE?</a></div>
      <div><a href="#privacyrights">6. WHAT ARE YOUR PRIVACY RIGHTS?</a></div>
      <div><a href="#DNT">7. CONTROLS FOR DO-NOT-TRACK FEATURES</a></div>
      <div><a href="#caresidents">8. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></div>
      <div><a href="#policyupdates">9. DO WE MAKE UPDATES TO THIS NOTICE?</a></div>
      <div><br /></div>
      <div><br /></div>
      ...
      <p>
        ...
        obtaining information about us or our products and Services, when you participate in activities on the Services
      ...
      <ul>
        <li>
          ...
          stamps associated with your usage, pages and files viewed, searches and other actions you take such as which
          features you use), device event information (such as system activity, error reports (sometimes called &#39;crash
          dumps&#39;) and hardware settings).
        </li>
      </ul>
      <div><br /></div>
      <h3 id="infouse"><strong>2. HOW DO WE USE YOUR INFORMATION?</strong></h3>
      <p>
        <strong><em>In Short:&nbsp;</em></strong>
        <em>
      ...
      <ul>
        <li>
          ...
          to send you product, service and new feature information and/or information about changes to our terms,
          conditions, and policies.
        </li>
        <li>
          <strong>To protect our Services.&nbsp;</strong>We may use your information as part of our efforts to
      ...
      <div><br /></div>
      <h3 id="infoshare"><strong>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</strong></h3>
      <p>
        <strong><em>In Short:&nbsp;</em></strong>
        <em>
      ...
      <div><br /></div>
      <h3 id="inforetain"><strong>4. HOW LONG DO WE KEEP YOUR INFORMATION?</strong></h3>
      <p>
        <strong><em>In Short:&nbsp;</em></strong>
        <em>
      ...
      <div><br /></div>
      <h3 id="infosafe"><strong>5. HOW DO WE KEEP YOUR INFORMATION SAFE?</strong></h3>
      <p>
        <strong><em>In Short:&nbsp;</em></strong>
        <em>
      ...
      <div><br /></div>
      <h3 id="privacyrights"><strong>6. WHAT ARE YOUR PRIVACY RIGHTS?</strong></h3>
      <p>
        <strong><em>In Short:&nbsp;</em></strong>
        <em>
          In some regions, such as the European Economic Area (EEA)
          and United Kingdom (UK), you have rights that allow you greater access to and control over your
      ...
      <div><br /></div>
      <h3 id="DNT"><strong>7. CONTROLS FOR DO-NOT-TRACK FEATURES</strong></h3>
      <p>
      ...
      <div><br /></div>
      <h3 id="caresidents"><strong>8. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</strong></h3>
      <p>
        <strong><em>In Short:&nbsp;</em></strong>
        <em>
      ...
      <p>
        ...
        have the right to request removal of unwanted data that you publicly post on the Services. To request removal
        of such data, please contact us, and include the email address associated with your account and a statement
        that you reside in California. We will make sure the data is not publicly displayed on the Services, but
        please be aware that the data may not be completely or comprehensively removed from all our systems
        (e.g. backups, etc.).
      </p>
      <p>
      ...
      <table>
        <tbody>
          <tr>
            <td>
              <br /><strong>Category</strong><br /><br />
            </td>
            <td>
              <br /><strong>Examples</strong><br /><br />
            </td>
            <td>
              <br /><strong>Collected</strong><br /><br />
            </td>
          </tr>
          <tr>
            <td>
      ...
      <p>
        Samiroy LLC &nbsp;has not disclosed or sold any personal information to third parties for a business
        or commercial purpose in the preceding 12 months. Samiroy LLC will not sell personal information in the
      ...
      <p>
        ...
        of verification. If, however, we cannot verify your identity from the information already maintained by us,
        we may request that you provide additional information for the purposes of verifying your identity, and for
      ...
      <div><br /></div>
      <h3 id="policyupdates"><strong>9. DO WE MAKE UPDATES TO THIS NOTICE?</strong></h3>
      <p>
